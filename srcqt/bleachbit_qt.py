...
# BleachBit Qt launcher
#
# This launches the alternative PySide6/Qt user interface.
#
...
if 'posix' == os.name:
    ...
    if len(sys.argv) == 1 or '--gui' in sys.argv:
        from bleachbit.Cleaner import HAVE_QT
        have_gui = HAVE_QT
    else:
        have_gui = False
...
The original GTK-based launcher remains bleachbit.py.
"""
...
if 1 == len(sys.argv) and have_gui:
    import bleachbit  # noqa: F401  - triggers environment setup
    from bleachbit.QtGUI import main_qt
    sys.exit(main_qt())
else:
