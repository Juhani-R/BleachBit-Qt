...
from bleachbit import APP_UI_TOOLKIT

if 'posix' == os.name:
    from bleachbit import Unix
    if APP_UI_TOOLKIT == 'Gtk':
...
class Cleaner:
    ...
    def get_option_description(self, option_id):
        """Return the name and description of certaion option"""
...
class System(Cleaner):
    ...
    def get_commands(self, option_id):
        ...
        if HAVE_QT and 'clipboard' == option_id:
